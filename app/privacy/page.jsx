      ...
      <main className="legal">
        <article className="legal__inner">
          <div className="legal__header">
            <span className="legal__label">// privacy_policy</span>
          ...
          <div className="legal__body">
            ...
            <ul>
              <li><strong>Cal.com</strong> — for scheduling. Subject to Cal.com&apos;s privacy policy.</li>
              <li><strong>Analytics provider</strong> — for anonymous usage analytics and site performance monitoring.</li>
