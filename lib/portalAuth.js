...
/**
 * Deduplicated per render. Both the page (via requirePortalClient) and PortalShell
 * need the viewer, and each call is an auth round trip plus a membership join — which
 * against a Supabase project on the far side of the world is ~500ms of pure latency
 * for an identical answer.
 */
export const getPortalViewer = cache(async function getPortalViewer() {
